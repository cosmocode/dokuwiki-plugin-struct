...
class DateFormatConverter
{
    protected static $strftime = [
        ...
        '%j' => '',
        // NOT SUPPORTED Day of the year, 3 digits with leading zeros    001 to 366
        '%u' => 'N',
        ...
        // Week
        '%U' => '',
        // NOT SUPPORTED Week number of the given year, starting with the first Sunday as the first week    13 (for the 13th full week of the year)
        '%V' => 'W',
        // ISO-8601:1988 week number of the given year, starting with the first week of the year with at least 4 weekdays, with Monday being the start of the week    01 through 53 (where 53 accounts for an overlapping week)
        '%W' => '',
        // NOT SUPPORTED A numeric representation of the week of the year, starting with the first Monday as the first week    46 (for the 46th week of the year beginning with a Monday)
        // Month
        '%b' => 'M',
        ...
        // Year
        '%C' => '',
        // NOT SUPPORTED Two digit representation of the century (year divided by 100, truncated to an integer)    19 for the 20th Century
        '%g' => 'y',
        ...
        '%l' => 'g',
        // (lower-case 'L') Hour in 12-hour format, with a space preceding single digits    1 through 12
        '%M' => 'i',
        ...
        '%R' => 'H:i',
        // Same as %H:%M    Example: 00:35 for 12:35 AM, 16:44for 4:44 PM
        '%S' => 's',
        ...
        '%c' => 'D M j H:i:s Y',
        // Preferred date and time stamp based on locale    Example: Tue Feb 5 00:45:10 2009 for February 5, 2009 at 12:45:10 AM
        '%D' => 'm/d/y',
    ...
    protected static $date = [
        ...
        'S' => '',
        // NOT SUPPORTED English ordinal suffix for the day of the month, 2 characters    st, nd, rd or th. Works well with j
        'w' => '%w',
        // Numeric representation of the day of the week    0 (for Sunday) through 6 (for Saturday)
        'z' => '',
        // NOT SUPPORTED The day of the year (starting from 0)    0 through 365
        // Week
        'W' => '%V',
        ...
        't' => '',
        // NOT SUPPORTED Number of days in the given month    28 through 31
        // Year
        'L' => '',
        // NOT SUPPORTED Whether it's a leap year    1 if it is a leap year, 0 otherwise.
        'o' => '%g',
        // ISO-8601 week-numbering year. This has the same value as Y, except that if the ISO week number (W) belongs to the previous or next year, that year is used instead. (added in PHP 5.1.0)    Examples: 1999or 2003
        'Y' => '%Y',
        // A full numeric representation of a year, 4 digits    Examples: 1999or 2003
        'y' => '%y',
        // A two digit representation of a year    Examples: 99 or03
        // Time
        'a' => '%P',
        ...
        'B' => '',
        // NOT SUPPORTED Swatch Internet time    000 through 999
        'g' => '%l',
        ...
        'u' => '%s000000',
        // Microseconds (added in PHP 5.2.2). Note that date() will always generate000000 since it takes an integer parameter, whereas DateTime::format()does support microseconds if DateTime was created with microseconds.    Example: 654321
        // Timezone
        'e' => '%Z',
        // Timezone identifier (added in PHP 5.1.0)    Examples: UTC,GMT,Atlantic/Azores
        'I' => '',
        // NOT SUPPORTED (capital i) Whether or not the date is in daylight saving time    1 if Daylight Saving Time, 0otherwise.
        'O' => '%z',
        ...
        'Z' => '',
        // NOT SUPPORTED Timezone offset in seconds. The offset for timezones west of UTC is always negative, and for those east of UTC is always positive.    -43200 through50400
        // Full Date/Time
        'c' => '',
        // NOT SUPPORTED ISO 8601 date (added in PHP 5)    2004-02-12T15:19:21+00:00
        'r' => '%a, %e %b %Y %H:%M:%S %s',
