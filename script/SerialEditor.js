 ...
 * Serial Editor
 */
var SerialEditor = function (idx, table) {
            ...
            var $btn = jQuery('<button><i class="ui-icon ui-icon-trash"></i></button>')
                ...
                .click(function (e) {
                    ...
                    jQuery.post(
                        ...
                        {
                            call: 'plugin_struct_serial_delete',
                            schema: schema,
                            pid: pid,
                            rid: rid,
                            sectok: $me.parents('.structserial').find('.struct_entry_form input[name=sectok]').val()
                        }
                    )
                        .done(function () {
                            $me.remove();
